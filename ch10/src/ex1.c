...
main(void)
{
    ...
    window = glfwCreateWindow(800, 600, "Zoom", NULL, NULL);
...
process_input(GLFWwindow *window)
{
    ...
    vec3 temp = GLM_VEC3_ZERO_INIT;
    vec3 forward = {camera_front[0], 0.0f, camera_front[2]};
    ...
    if (glfwGetKey(window, GLFW_KEY_W) == GLFW_PRESS)
        glm_vec3_muladds(forward, camera_speed, camera_pos);
...
void
mouse_callback(GLFWwindow *window, double x_pos_in, double y_pos_in)
{
