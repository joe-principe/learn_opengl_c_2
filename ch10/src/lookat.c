...
main(void)
{
    ...
    vec3 camera_dir = GLM_VEC3_ZERO_INIT;
    ...
    glm_vec3_sub(camera_pos, camera_target, camera_dir);
    glm_normalize(camera_dir);

    glm_cross(up, camera_dir, camera_right);
    glm_normalize(camera_dir);

    glm_cross(camera_dir, camera_right, camera_up);
    ...
    window = glfwCreateWindow(800, 600, "LookAt", NULL, NULL);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glm_lookat((vec3){cam_x, 0.0f, cam_z}, GLM_VEC3_ZERO,
