...
main(void)
{
    ...
    const char *cube_vert_shader_path = "shaders/cube_ex3.vert";
    const char *cube_frag_shader_path = "shaders/cube_ex3.frag";

    const char *light_vert_shader_path = "shaders/light_ex3.vert";
    const char *light_frag_shader_path = "shaders/light_ex3.frag";
    ...
    window = glfwCreateWindow(800, 600, "Chapter 13 Example 3", NULL, NULL);
