...
main(void)
{
    ...
    window = glfwCreateWindow(800, 600, "Chapter 5 - Example 2", NULL, NULL);
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(vertices_A), vertices_A,
                 GL_STATIC_DRAW);
    ...
    /* We then copy the vertex data to the VBO */
    glBufferData(GL_ARRAY_BUFFER, sizeof(vertices_B), vertices_B,
                 GL_STATIC_DRAW);
