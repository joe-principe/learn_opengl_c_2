...
main(void)
{
    ...
    window = glfwCreateWindow(800, 600, "Chapter 6 - Example 2", NULL, NULL);
    ...
    create_shader(&sh,
              "/home/joe/Programming/c/learn_opengl/ch06/shaders/ex2.vs",
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        horizontal_offset = sin(time_value) / 2.0f;
        vertex_offset_location = glGetUniformLocation(sh.ID, "offset");

        glUniform1f(vertex_offset_location, horizontal_offset);
