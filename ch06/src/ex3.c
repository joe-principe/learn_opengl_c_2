...
main(void)
{
    ...
    create_shader(&sh,
                  "/home/joe/Programming/c/learn_opengl/ch06/shaders/ex3.vs",
                  "/home/joe/Programming/c/learn_opengl/ch06/shaders/ex3.fs");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        horizontal_offset = cos(time_value) / 2.0f;
        vertical_offset = sin(time_value) / 2.0f;
        vertex_offset_location = glGetUniformLocation(sh.ID, "offset");

        glUniform2f(vertex_offset_location, horizontal_offset, vertical_offset);
