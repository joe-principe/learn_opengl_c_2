...
main(void)
{
    ...
    const char *cube_vert_shader_path = "shaders/cube_dm.vert";
    const char *cube_frag_shader_path = "shaders/cube_dm.frag";

    const char *light_vert_shader_path = "shaders/light_dm.vert";
    const char *light_frag_shader_path = "shaders/light_dm.frag";
    ...
    window = glfwCreateWindow(800, 600, "Diffuse Mapping", NULL, NULL);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        /* Cube properties */
        glUniform3f(glGetUniformLocation(cube_shader.ID, "material.ambient"),
                    1.0f, 0.5f, 0.31f);
        glUniform3f(glGetUniformLocation(cube_shader.ID, "material.diffuse"),
                    1.0f, 0.5f, 0.31f);
        glUniform3f(glGetUniformLocation(cube_shader.ID, "material.specular"),
                    0.5f, 0.5f, 0.5f);
