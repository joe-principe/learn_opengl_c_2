...
main(void)
{
    ...
    const char *cube_vert_shader_path = "shaders/cube_ex2.vert";
    const char *cube_frag_shader_path = "shaders/cube_ex2.frag";

    const char *light_vert_shader_path = "shaders/light_ex2.vert";
    const char *light_frag_shader_path = "shaders/light_ex2.frag";
    ...
    window = glfwCreateWindow(800, 600, "Chapter 15 Example 2", NULL, NULL);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glUniform3fv(glGetUniformLocation(cube_shader.ID, "light.diffuse"), 1,
                     (float *)diffuse_color);
        glUniform3f(glGetUniformLocation(cube_shader.ID, "light.specular"),
                    1.0f, 1.0f, 1.0f);
