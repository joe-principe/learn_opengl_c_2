...
main(void)
{
    ...
    vec3 specular_color = GLM_VEC3_ONE_INIT;
    ...
    window = glfwCreateWindow(800, 600, "Chapter 15 Example 1", NULL, NULL);
    ...
    glUniform1i(glGetUniformLocation(cube_shader.ID, "material.diffuse"), 0);
    glUniform1i(glGetUniformLocation(cube_shader.ID, "material.specular"), 1);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glUniform3fv(glGetUniformLocation(cube_shader.ID, "light.position"), 1,
                     (float *)light_pos);
        ...
        glm_vec3_mul(light_color, GLM_VEC3_ONE, specular_color);
        glm_vec3_mul(light_color, (vec3){0.5f, 0.5f, 0.5f}, diffuse_color);
        glm_vec3_mul(diffuse_color, (vec3){0.2f, 0.2f, 0.2f}, ambient_color);

        glUniform3fv(glGetUniformLocation(cube_shader.ID, "light.ambient"), 1,
                     (float *)ambient_color);
        glUniform3fv(glGetUniformLocation(cube_shader.ID, "light.diffuse"), 1,
                     (float *)diffuse_color);
        glUniform3fv(glGetUniformLocation(cube_shader.ID, "light.specular"), 1,
                     (float *)specular_color);

        /* Cube properties */
        glUniform1f(glGetUniformLocation(cube_shader.ID, "material.shininess"),
                    32.0f);
        ...
        glUniform3fv(glGetUniformLocation(light_shader.ID, "lightColor"), 1,
                     (float *)light_color);
