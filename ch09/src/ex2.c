...
main(void)
{
    ...
    window = glfwCreateWindow(800, 600, "Chapter 9 - Example 2", NULL, NULL);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        /* 
         * Changing the translation for the view matrix just moves the viewer's
         * position
         */
        glm_mat4_identity(view);
        glm_translate(view, (vec3){-1.0f, 0.1f, -3.0f});
