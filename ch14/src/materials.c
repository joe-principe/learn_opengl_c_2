...
main(void)
{
    ...
    const char *cube_vert_shader_path = "shaders/cube_materials.vert";
    const char *cube_frag_shader_path = "shaders/cube_materials.frag";

    const char *light_vert_shader_path = "shaders/light_materials.vert";
    const char *light_frag_shader_path = "shaders/light_materials.frag";
    ...
    window = glfwCreateWindow(800, 600, "Materials", NULL, NULL);
