...
main(void)
{
    ...
    window = glfwCreateWindow(800, 600, "Light Properties", NULL, NULL);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glUniform3f(glGetUniformLocation(cube_shader.ID, "light.ambient"),
                    0.2f, 0.2f, 0.2f);
        glUniform3f(glGetUniformLocation(cube_shader.ID, "light.diffuse"),
                    0.5f, 0.5f, 0.5f);
