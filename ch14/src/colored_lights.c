...
main(void)
{
    ...
    const char *cube_vert_shader_path = "shaders/cube_lp.vert";
    const char *cube_frag_shader_path = "shaders/cube_lp.frag";

    const char *light_vert_shader_path = "shaders/light_lp.vert";
    const char *light_frag_shader_path = "shaders/light_lp.frag";
    ...
    window = glfwCreateWindow(800, 600, "Colored Lights", NULL, NULL);
