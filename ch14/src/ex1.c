...
main(void)
{
    ...
    const char *cube_vert_shader_path = "shaders/cube_ex1.vert";
    const char *cube_frag_shader_path = "shaders/cube_ex1.frag";

    const char *light_vert_shader_path = "shaders/light_ex1.vert";
    const char *light_frag_shader_path = "shaders/light_ex1.frag";
    ...
    window = glfwCreateWindow(800, 600, "Chapter 14 Example 1", NULL, NULL);
